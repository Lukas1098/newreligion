            ...
            <section id='hero' className="min-h-screen relative">
                <div className="relative w-full h-screen overflow-hidden">
                        ...
                        >
                            {bg.type === "video" ? (
                                ...
                                <Image 
                                    ...
                                    alt="Background"
                                    fill
                                    className="object-cover opacity-50 dark:opacity-35"
                                />
                            )}
                        </div>
                    ))}
                    ...
                    <div className="absolute inset-0 bg-opacity-50 flex flex-col items-center justify-center">
                        ...
                        />
                        <p className="mx-6 sm:mx-8 md:mx-auto mt-4 max-w-lg text-center text-base font-normal text-white-300 px-4 sm:px-0">
